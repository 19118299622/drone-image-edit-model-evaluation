...
本文件用于记录基础任务共享 Prompt，供 `TC-01` 和 `TC-03` 共用。你不需要关心 Markdown 语法，只需要把 `待填写` 替换成你的内容，或者复制一个完整的“Prompt 槽位”继续往下加。
...
`观察模型是否能从简短直译指令中识别白色主体建筑，并生成基本可见的扫描路线。`

结果图片文件名建议：

- TC-01 BAGEL：`TC01_BASIC_P01_bagel_R01.png`
- TC-01 Qwen：`TC01_BASIC_P01_qwen_R01.png`
- TC-03 BAGEL：`TC03_BASIC_P01_bagel_R01.png`
- TC-03 Qwen：`TC03_BASIC_P01_qwen_R01.png`
...
`强调原图保持、主路线与辅助路线区分、方向箭头、起点、连续性和避免穿墙或随机曲线。`

预期观察点：

`观察模型是否更稳定地保留原图，并生成更贴合建筑轮廓的连续路线。`

结果图片文件名建议：

- TC-01 BAGEL：`TC01_BASIC_P02_bagel_R01.png`
- TC-01 Qwen：`TC01_BASIC_P02_qwen_R01.png`
- TC-03 BAGEL：`TC03_BASIC_P02_bagel_R01.png`
- TC-03 Qwen：`TC03_BASIC_P02_qwen_R01.png`
...
- TC-01 BAGEL：`TC01_BASIC_P03_bagel_R01.png`
- TC-01 Qwen：`TC01_BASIC_P03_qwen_R01.png`
- TC-03 BAGEL：`TC03_BASIC_P03_bagel_R01.png`
- TC-03 Qwen：`TC03_BASIC_P03_qwen_R01.png`

## 修改记录

- 2026-06-29：建立基础任务共享 Prompt 文件，供 TC-01 与 TC-03 共用。
